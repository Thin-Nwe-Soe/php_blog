                  ...
                  <tbody>
                    ...
                    if($result){
                      ...
                      <td>
                        ...
                        <div class="container">
                          <a href="user_delete.php?id=<?php echo $value['id'] ?>" onclick="return confirm('Are you sure you want to delete this item?')" type="button" class="btn btn-danger">Delete</a>
                        </div>
                      </div>
                      </td>
                    </tr>
